...
export declare function SelectPopover({ opened, transitionProps, shadow, withinPortal, children, __staticSelector, onDirectionChange, switchDirectionOnFlip, zIndex, dropdownPosition, positionDependencies, classNames, styles, unstyled, readOnly, variant, }: SelectPopoverProps): JSX.Element;
