...
export declare function useUncontrolledDates<Type extends DatePickerType = 'default'>({ type, value, defaultValue, onChange, }: UseUncontrolledDates<Type>): [any, (value: any) => void, boolean];
export {};
