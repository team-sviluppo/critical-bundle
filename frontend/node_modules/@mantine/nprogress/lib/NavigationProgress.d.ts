...
export declare function NavigationProgress({ initialProgress, color, size, stepInterval, transitionDuration, exitTimeout, exitTransitionDuration, onFinish, autoReset, withinPortal, zIndex, progressLabel, }: NavigationProgressProps): JSX.Element;
